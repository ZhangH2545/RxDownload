...
import com.zhang.rxdownload.entity.DownloadRange;
...
import static com.zhang.rxdownload.function.Constant.CHUNKED_DOWNLOAD_HINT;
import static com.zhang.rxdownload.function.Utils.GMTToLong;
import static com.zhang.rxdownload.function.Utils.closeQuietly;
import static com.zhang.rxdownload.function.Utils.isChunked;
import static com.zhang.rxdownload.function.Utils.log;
import static com.zhang.rxdownload.function.Utils.longToGMT;
    ...
    public void saveFile(FlowableEmitter<DownloadStatus> emitter, File saveFile,
        ...
        try {
            try {
                ...
                boolean aa = isChunked(resp);
                if (aa || contentLength == -1) {
